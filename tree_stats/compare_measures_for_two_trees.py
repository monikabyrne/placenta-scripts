...
def plot_measure(mean_measure1, sd_measure1,mean_measure2, sd_measure2,label1,label2,ylabel,title):
    ...
    fig, ax = plt.subplots()
    rects1 = ax.bar(ind - width / 2, mean_measure1, width, yerr=sd_measure1,
                    color='SkyBlue', label=label1)
    rects2 = ax.bar(ind + width / 2, mean_measure2, width, yerr=sd_measure2,
...
path1 = 'full_tree_patient_51_21_v2/'
path2 = 'full_tree_patient_51_22_v2/'
