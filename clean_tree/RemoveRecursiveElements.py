...
#read the node file
node_file = pd.read_csv('chorionic_vessels/chor_nodes_cycle2_v3.exnode', sep="\n", header=None)
...
element_file = pd.read_csv('chorionic_vessels/chor_elems_cycle2_v3.exelem', sep="\n", header=None)
...
pg.export_ex_coords(new_node_loc, 'chor_nodes_cycle2_v4', 'chorionic_vessels/chor_nodes_cycle2_v4', 'exnode')
...
pg.export_exelem_1d(new_elems, 'chor_elems_cycle2_v4', 'chorionic_vessels/chor_elems_cycle2_v4')